...
export class Migration20241101191158 extends Migration {
  override async up(): Promise<void> {
    this.addSql(
      `create table \`seed_group\` (\`id\` integer not null primary key autoincrement, \`name\` text not null);`
    );
    this.addSql(
